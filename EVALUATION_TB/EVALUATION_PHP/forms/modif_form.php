...
<div class="container">
    ...
    <form action="../scripts/script_modif.php?pro_id=<?= $row->pro_id ?>" method="POST">
        <div class="form-group">
            <img style="width: 250px;" class="img-responsive img-fluid rounded mx-auto d-block" src="../jarditou_html_zip/jarditou_photos/<?= $tableau[0] ?>.jpg" alt="">
            <div>
                <label>ID :</label><br>
